(() => {
    ...
    function initSliders() {
        if (document.querySelector(".marcket__slider")) new core(".marcket__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".marcket__button--left",
                nextEl: ".marcket__button--right"
            },
            on: {}
        });
    }
...
***************************************************************************** */
    ...
    const work = document.querySelector(".top");
    const navHeight = header.getBoundingClientRect().height;
    document.querySelector(".header-open");
    const getStickyNav = function(entries) {
        const entry = entries[0];
        if (!entry.isIntersecting) {
            header.style.position = "fixed";
            header.classList.add("header-open");
            document.querySelector(".header__container").style.minHeight = "70px";
            document.querySelector(".header__container").classList.add("header-container");
        } else {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        L.marker([ 49.460418, 28.516203 ]).addTo(map).bindPopup("Заїзд").openPopup();
        L.marker([ 49.460995, 28.514516 ]).addTo(map).bindPopup("Автомайстерня<br> BIG GARAGE").openPopup();
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
